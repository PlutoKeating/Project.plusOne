# 🧰 第 5 章：小艾的工具箱与记忆库 — Tool, MCP, Memory

## 故事：工具箱与记忆库

小艾学会调用工具后，问题也接踵而至。

有一天，老张检查小艾的"工具箱"，发现是这样的场景：
...
同时，老张还发现了另一个问题：小艾**没有记忆**。

用户说"刚才我让你查了北京的天气，再帮我查一下上海的"，小艾一脸茫然——"刚才？什么刚才？我们说过话吗？"
...
小艾：上海多云，28°C。 ← 因为没有记忆，上下文窗口里需要保留前一轮对话
```
...
# 测试
agent = AgentWithMemory("你是友好的助手小艾，用中文回答。")
...
> **小艾说：** "我的工具箱整齐了，记忆系统也装上了！现在我能做的事越来越多了。但有些任务太复杂了，我一个人忙不过来……也许我需要几个小伙伴来帮忙。"

---

**→ 下一步：[第 6 章：小艾的团队 — Multi-Agent 何时用](chapter06-multi-agent.md)**
